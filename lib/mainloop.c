...
{
  cfgfilename = get_installation_path(PATH_SYSLOG_NG_CONF);
  persist_file = get_installation_path(PATH_PERSIST_CONFIG);
  ctlfilename = get_installation_path(PATH_CONTROL_SOCKET);
  module_path = get_installation_path(MODULE_PATH);
}
